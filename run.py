...
element, el_num, max_levels, min_levels = create_inp(out_dir, spec_numbers, translation_table, ionization_potential)
create_aiw(out_dir, spec_numbers, translation_table,max_levels, min_levels)
