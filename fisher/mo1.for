     ...
     +     nXE= 2              ! number of chemical elements (XE) in present simulation: nX=1 is AL, nX=2 is MG. 
      integer, public :: 
...
c                                In "Intro" & ionization we assume that state #Nnu(nX) is nucleus  
     +     NST(nXE)  ! TOTAL number of QSs on the list: "regular" +AI 
      ...
      DATA FSS / 10,  9/,   ! all Be-like SSs of AL & MG
     +     HSS / 13, 12/,   !     H -like SSs
     +     Nnu /109, 109/,  ! nuclei # in the QS list of XE. It == the number of "regular" QSs (not AI) 
     +     NST /272, 272/   ! number of states in the databases of Al and Mg  
      integer, public, parameter :: 
     +     NSTm = 272,             ! max of two "NST"	   
     +     HSSm =  13,                  ! highest (of all XE) SS of H-like ion
     +    Nwork = 50+ 12*NSTm+ NSTm**2  ! For NAG d02eaf (Gear) workArea 'WEAF'	

      integer, public, parameter :: 
     +   nFAI = 201,   ! in each SS, containing AI QSs, serial number of lowest AI QS.  
