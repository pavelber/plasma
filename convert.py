...
def print_transitions(trans_f, ss, levels_energy, ai_coef,start_level,start_ai_level):
	...
	for line in trans_f:
		...
		if len(columns)>5: #Skip empty lines
			...
			out = OUTPUT_FORMAT_STRING % (col_1_ss,col_2_up_level,col_3_up_stat_weight,col_4_up_energy,col_5_low_level,col_6_low_stat_weight,col_7_low_energy,col_8_photon_energy,col_9_einstein,col_10_std_dev)
