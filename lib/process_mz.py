...
# TODO: change
def create_ke_he(parts):  # level config, stat weight
    ...
    with open(os.path.join(out_dir, "IN1.INP"), "rb") as inf:
        ...
        for line in inf:
            ...
            if len(parts) == 1:
                spect_num = parts[0]
            if len(parts) == 7:
                levels[(spect_num, parts[5])] = \
                    parts[2], parts[3]  # TODO change - last part of level configuration and stat weight
    return levels
