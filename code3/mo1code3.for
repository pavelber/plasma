...
c                                nX=1,2,3,4 is Fe, Cr, Ni, Mn 
     ...
     +   LaMx = 3,      ! Number of zones	(here all BSs are treated as one zone)
     ...
     +  k, kf, kfr, kfrp,	 ! variable integers
     +  j, jx, i, iw, CoFr,
     +  iv, kw, k7, k1, k2,
     +  iSS, jSS, kQS, kS, ! variable integers
     +  kU, kL, lin, nLam, 
     +  nXw, n7, lw, iX,   ! variable integers
     ...
     +   RadPow(nvL),           ! [W/eV/sr) from x-bright 3-zone sphere (XBR)  
     ...
     +   R3t(ntp),  ! radius of Halo [cm] in the t-point #tip
